...
to_keep <- c(FT01080 = "1,5-anhydro D-glucitol",
             ...
             FT00548 = "3-Methylxanthine", #same as 1-Methylxanthine
             FT00190 = "5-Oxoproline",
             FT00548 = "7-Methylxanthine", #same as 1- and 3-Methylxanthine
             FT02121 = "8-Oxo-2-Deoxyguanosine",
             FT00213 = "Acetylalanine",
             FT01859 = "Acetyl-Glucosamine",
             FT00139 = "Acetylglyine",
             ...
             FT00093 = "Serine",
             FT00734 = "Sorbitol",
             FT04232 = "Sphingosine-1-phosphate",
...
plot_pca(pc, col = "#00000080",
         ...
         pc_x = 1, pc_y = 2, pch = pchs[std_res$storage])
plot_pca(pc, col = "#00000080",
         bg = paste0(col_time[as.character(std_res$time)], 90),
         pc_x = 3, pc_y = 4, pch = pchs[std_res$storage])
...
std_res$storage_time <- paste0(std_res$storage, "_", std_res$time)
...
plot_pca(pc, col = "#00000080",
         ...
         pc_x = 1, pc_y = 2, pch = pchs[std_res_avg$storage])
plot_pca(pc, col = "#00000080",
         bg = paste0(col_time[as.character(std_res_avg$time)], 90),
         pc_x = 3, pc_y = 4, pch = pchs[std_res_avg$storage])
legend("topleft", pch = pchs, legend = names(pchs),
       title = "storage", ncol = 2)
```
