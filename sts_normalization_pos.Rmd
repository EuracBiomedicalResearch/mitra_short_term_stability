...
col <- col_storage[as.character(res_pos$storage)]
...
tmp_fv <- assay(res_pos, "raw")[is_info$feature_id, ]
...
par(mfrow = c(2, 2), mar = c(4, 4, 1, 0.5))
plot_pca(pc_raw_pool, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
...
plot_pca(pc_raw_pool, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
         ...
         pch = pch, col = "#00000080")
plot_pca(pc_norm_pool, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
...
pch <- rep(21, ncol(res_pos))
par(mfrow = c(2, 2), mar = c(4, 4, 1, 0.5))
plot_pca(pc_raw_rt, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
...
plot_pca(pc_raw_rt, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
         ...
         pch = pch, col = "#00000080")
plot_pca(pc_norm_rt, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
...
par(mfrow = c(2, 2), mar = c(4, 4, 1, 0.5))
plot_pca(pc_raw_bag, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
...
plot_pca(pc_raw_bag, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
         ...
         pch = pch, col = "#00000080")
plot_pca(pc_norm_bag, bg = paste0(col_storage[as.character(res_pos$storage)], 80),
...
pc_raw <- prcomp(
    t(log2(assay(res_pos, "raw_filled_imputed")[is_info$feature_id, ])),
    scale = FALSE, center = TRUE)
pc_norm <- prcomp(
    t(log2(assay(res_pos, "normalized_filled_imputed")[is_info$feature_id, ])),
    scale = FALSE, center = TRUE)
pch <- rep(21, ncol(res_pos))
...
tmp_is <- assay(res_pos, "raw_filled")[is_info$feature_id, ]
rsd_raw_is <- rowRsd(tmp_is[, res_pos$storage == "QC"])
tmp_is <- assay(res_pos, "median_filled")[is_info$feature_id, ]
rsd_scl_is <- rowRsd(tmp_is[, res_pos$storage == "QC"])
tmp_is <- assay(res_pos, "normalized_filled")[is_info$feature_id, ]
