...
[sts_untargeted_pos.Rmd](sts_untargeted_pos.Rmd) for more information on these
quality criteria.
...
```{r}
rowData(res_pos)$RSD <- rsds
rowData(res_pos)$Dratio <- dratios
```
...
for (i in seq(nrow(std_info))) {
    ...
    std_info$mz_ion[i] <- mass2mz(
        std_info$exact_mass[i], adduct = std_info[i, "POS"])[1, 1]
}
...
std_match <- matchMz(res_pos, std_info, param = par,
...
to_keep <- c(FT00603 = "1-Methylhistidine",
             FT00604 = "3-Methylhistidine", ## same as 1-Methylhistidine
             FT00322 = "5-Oxoproline",
             FT01650 = "8-Oxo-2-Deoxyguanosine",
             FT00913 = "Acetylcarnitine",
             FT01255 = "Acetyl-Glucosamine",
             ## FT00912 = "Acetylcarnitine",
             FT00851 = "Acetylhistidine",
             FT00902 = "ADMA",
             FT03607 = "ADP",
             FT00128 = "Alanine",
             FT02793 = "alpha-Lactose",
             FT02551 = "AMP",
             FT00644 = "Arginine",
             FT00340 = "Asparagine",
             FT00241 = "Betaine",
             ...
             FT03607 = "dGDP",
             FT02552 = "dGMP",
             FT00895 = "Fructose", # same as glucose and mannose
             FT00918 = "Galactitol", # same as sorbitol
             FT00895 = "Glucose", # same as Fructose
             FT00446 = "Glutamine",
             FT06228 = "Glutathione Oxidized", # same as Glu. Reduced
             FT06228 = "Glutathione Reduced", # same as Glu. Oxidized
             FT00606 = "Glyceraldehyde 2-phosphate",
             FT01380 = "Glycero-phosphocholine",
             FT00061 = "Glycine",
             FT01650 = "Guanosine",
             FT00205 = "Histamine",
             FT00509 = "Histidine",
             FT00335 = "Hydroxyproline",
             FT00376 = "Hypoxanthine",
             FT00337 = "Isoleucine",
             FT00981 = "L,L-Cyclo(leucylprolyl)",
             FT00350 = "L-Aspartic Acid",
             FT00255 = "L-Cysteine",
             FT00337 = "Leucine", #same as Isoleucine
             FT00459 = "L-Glutamic Acid",
             FT00449 = "Lysine",
             FT00895 = "Mannose", # same as Fructose and Glucose
             FT00471 = "Methionine",
             FT00576 = "Methioninesulfoxide",
             FT00642 = "N-Acetylornithine",
             FT06937 = "NAD",
             FT00342 = "Ornithine",
             FT03268 = "Palmitoylcarnitine",
             FT00579 = "Phenylalanine",
             FT00257 = "Phenylethylamine",
             FT00722 = "Phosphorylcholine",
             FT00416 = "Phosphorylethanolamine",
             FT00234 = "Proline",
             FT03080 = "SAH",
             FT03264 = "SAMe",
             FT00902 = "SDMA",
             FT00180 = "Serine",
             FT00918 = "Sorbitol",
             FT03019 = "Sphingosine-1-phosphate",
             FT01870 = "Sphingosine",
             FT02793 = "Sucrose",
             FT00297 = "Taurine",
             FT00247 = "Threonine",
...
**Sphingosine-1-phosphate** (FT03019) which shows a low intensity in samples
...
The rather surprising decrease of the number of significant metabolites for later
time points seen in the barplots above might eventually be caused by an
...
write_xlsx(as.data.frame(rowData(res_pos)),
           "mitra_short_term_stability_semi_pos.xlsx")
```
