...
## source("sts_normalization_functions.R")
...
signal, especially for features with higher abundances. 
...
The distribution of feature intensities seems to
be comparable between samples and storage methods. The high similarity of
...
pch <- rep(21, ncol(res_neg))
par(mfrow = c(2, 2), mar = c(4, 4, 1, 0.5))
plot_pca(pc_raw_rt, bg = paste0(col_storage[as.character(res_neg$storage)], 80),
...
plot_pca(pc_raw_rt, bg = paste0(col_storage[as.character(res_neg$storage)], 80),
         ...
         pch = pch, col = "#00000080")
plot_pca(pc_norm_rt, bg = paste0(col_storage[as.character(res_neg$storage)], 80),
